...
**OC-R-037** — A CSMS TLS server certificate shall come either from PEM files on disk or from an ephemeral self-signed certificate generated in memory at each server start and never written to disk.
