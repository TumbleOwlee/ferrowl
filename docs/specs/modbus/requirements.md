...
**MB-R-253** — The monitor module rebuilt by an applied configuration edit (MB-R-255) carries the pre-edit frame table, captured records, message log and register interpretations forward unchanged.

**MB-R-254** — The monitor module rebuilt by an applied configuration edit (MB-R-255) is not started by the apply; it stays stopped until an explicit start (UI-R-314).
