...
mod tests {
    ...
    /// MB-R-108/OC-R-133 — `CertVerification::RootStore` is rejected on a server's
    ...
    /// MB-R-109/OC-R-130 — `CertVerification::CaFiles` with an empty `ca_files` is rejected at
