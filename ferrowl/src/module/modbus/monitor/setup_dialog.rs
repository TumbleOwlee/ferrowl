...
mod tests {
    ...
    /// UI-R-067, UI-R-351 — the name field is focused, and so shows a cursor, as soon as the dialog opens,
    ...
    /// UI-R-352 — a freshly created dialog paints exactly one text cursor, in the one focused
