...
//! `CsState` and the `ClientVersion` method bodies are shared with 2.1 as plain free functions in
//! [`v2_common`](crate::module::ocpp::client::v2_common); this `impl` wires in the 2.0.1 inbound
//! handler and action specs (the two seams that actually differ per version).
