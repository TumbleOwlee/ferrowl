...
fn it_headless_run_starts_monitor_module() {
    let dir = ferrowl_test_support::reserve_temp_dir("ferrowl_it_headless_monitor");
...
fn it_headless_fails_on_monitor_module_with_bad_device_path() {
    let dir = ferrowl_test_support::reserve_temp_dir("ferrowl_it_headless_monitor_bad");
