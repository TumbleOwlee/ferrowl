...
`.claude/AGENTS.workflow.md` is authority for gate 1 and 1b — the headings in the table below, followed exactly. This skill is the entrypoint only; it restates nothing. Conflict → `.claude/AGENTS.workflow.md` wins.
